(function(andRedEyeLikeGettingPersonal, undefined) {
    ...
    SL.andRedEyeLikeGettingPersonal = {
        ...
        pgCssDesktop: function() {
            ...
            var mainCss = " .bannerClass {padding-bottom:7em; padding-top:20px; background:#ededed;} .heroimg {border-top:4px solid #fff; border-left:4px solid #fff; border-right:0; border-bottom:0;} .forty {margin-bottom:2.75em;} .modal-backdrop.in { opacity:0; } ";
        ...
        removals: function() {
            ...
            var moo = document.querySelector('.modal-backdrop.in');
            moo.className += " fixer";
            //main
            ...
            center.removeEventListener("DOMNodeRemoved", function(e) {
              console.log('removed');
            });
