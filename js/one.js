(function(andRedEyeLikeGettingPersonal, undefined) {
    ...
    SL.andRedEyeLikeGettingPersonal = {
        ...
        removals: function() {
            //nav
            var topnav = document.querySelectorAll('.navcontainer')[0];
        ...
        addonTwo: function() {
            ...
            console.info('%c addonTwo \u221a', 'background:blue;color:white;');
            var addons = document.createElement('div');
            addons.id = "heroBanner";
            addons.className = 'bannerClass';
            var handle = document.getElementById('content');
        ...
        addonThree: function() {
            ...
            console.info('%c addonThree \u221a', 'background:blue;color:white;');
            var addons = document.createElement('div');
            addons.id = "heroBanner";
            addons.className = 'bannerClass';
            var handle = document.getElementById('content');
        ...
        addonFour: function() {
            ...
            console.info('%c addonFour \u221a', 'background:blue;color:white;');
            var addons = document.createElement('div');
            addons.id = "heroBanner";
            addons.className = 'bannerClass';
            var handle = document.getElementById('content');
        ...
        addonFive: function() {
            ...
            console.info('%c addonFive \u221a', 'background:blue;color:white;');
            var addons = document.createElement('div');
            addons.id = "heroBanner";
            addons.className = 'bannerClass';
            var handle = document.getElementById('content');
        ...
        addonSix: function() {
            ...
            console.info('%c addonSix \u221a', 'background:blue;color:white;');
            var addons = document.createElement('div');
            addons.id = "heroBanner";
            addons.className = 'bannerClass';
            var handle = document.getElementById('content');
